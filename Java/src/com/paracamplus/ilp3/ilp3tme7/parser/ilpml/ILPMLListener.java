...
import antlr4.ILPMLgrammar3tme7Listener;
import antlr4.ILPMLgrammar3tme7Parser.CostartContext;
import static antlr4.ILPMLgrammar3tme7Parser.*;

public class ILPMLListener implements ILPMLgrammar3tme7Listener {
	...
	@Override
	public void enterCostart(CostartContext ctx) { }

	@Override
	public void exitCostart(CostartContext ctx) {
		ctx.node = factory.newStart(
				ctx.fun.node, 
				toExpressions(ctx.args));
	}
}
