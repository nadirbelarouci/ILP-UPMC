...
#include <string.h>
#include <setjmp.h>
#include <ucontext.h> /* Ajout TME 7 */
...
extern ILP_Object ILP_start(void (*f)(), int arc, ...);
...
#define ILP_isCoroutine(o) \
  ((o)->_class == &ILP_object_Coroutine_class)

#define ILP_CheckIfCoroutine(o) \
  if ( ! ILP_isCoroutine(o) ) { \
       ILP_domain_error("Not a coroutine", o); \
  };
