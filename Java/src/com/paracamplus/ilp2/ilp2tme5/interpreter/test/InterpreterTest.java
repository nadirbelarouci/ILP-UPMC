...
import com.paracamplus.ilp2.ilp2tme5.parser.xml.XMLParser;

@RunWith(Parameterized.class)
public class InterpreterTest extends com.paracamplus.ilp2.interpreter.test.InterpreterTest {
   
	protected static String[] samplesDirName = { "SamplesTME5", "SamplesILP2", "SamplesILP1" };
	protected static String XMLgrammarFile = "XMLGrammars/grammar2-tme5.rng";
